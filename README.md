...
- Run the following command:
    ...
    Vinh: python src/test.py checkpoint_path=src/pretrained/csec.ckpt
    Vinh: & d:/HCMIU/SpecialStudySrc/CSEC/.conda/python.exe d:/HCMIU/SpecialStudySrc/CSEC/src/test.py checkpoint_path=src/pretrained/csec.ckpt
    ```
